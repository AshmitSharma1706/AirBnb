...
public class AuthService {
    ...
    public UserDto signUp(SignUpRequestDto signUpRequestDto){
        User existing=userRepository.findByEmail(signUpRequestDto.getEmail()).orElse(null);
        if(existing!=null){
            throw new RuntimeException("User already exist with email "+existing.getEmail());
        }
